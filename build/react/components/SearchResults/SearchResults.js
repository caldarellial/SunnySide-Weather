...
module.exports={"container":"_container_1sq9v_1","content":"_content_1sq9v_14","result":"_result_1sq9v_18"}
...
var styles = require('./SearchResults.css.json');
function SearchResults(props) {
    return (react_1.default.createElement("div", { className: styles.container },
        react_1.default.createElement("div", { className: styles.content }, (props.results || []).map(function (result) {
            return react_1.default.createElement(SearchResult, { result: result });
        }))));
}
exports.SearchResults = SearchResults;
function SearchResult(props) {
    var _a = react_1.useState(null), placeId = _a[0], setPlaceId = _a[1];
    var label = hooks_1.useLocationName(props.result);
    react_1.useEffect(function () {
        setPlaceId(props.result.place_id);
    }, [props.result]);
    return (react_1.default.createElement("a", { className: styles.result, href: "/location/" + placeId }, label));
}
exports.default = SearchResults;

},{"../../hooks":3,"./SearchResults.css.json":1,"react":16}],3:[function(require,module,exports){
"use strict";
function __export(m) {
