...
module.exports={"container":"_container_1cx5v_1","city":"_city_1cx5v_6"}
...
var Error_1 = __importDefault(require("../Error/Error"));
var WeatherIndicator_1 = __importDefault(require("../WeatherIndicator/WeatherIndicator"));
var hooks_1 = require("../../hooks");
var LoadingIndicator_1 = __importDefault(require("../LoadingIndicator/LoadingIndicator"));
var styles = require('./CurrentCard.css.json');
function CurrentCard(props) {
    var _a = hooks_1.useLocationWeather(props.latitude, props.longitude, true), weather = _a.weather, loading = _a.loading, error = _a.error;
    function renderWeather() {
        return (react_1.default.createElement(react_1.default.Fragment, null,
            react_1.default.createElement("div", { className: styles.city }, props.city),
            react_1.default.createElement(WeatherIndicator_1.default, { weather: weather.currently })));
    }
...
exports.default = CurrentCard;

},{"../../hooks":10,"../Error/Error":4,"../LoadingIndicator/LoadingIndicator":5,"../WeatherIndicator/WeatherIndicator":7,"./CurrentCard.css.json":1,"react":23}],3:[function(require,module,exports){
module.exports={"container":"_container_sx4oc_1","icon":"_icon_sx4oc_7"}
...
Object.defineProperty(exports, "__esModule", { value: true });
var react_1 = __importDefault(require("react"));
var styles = require('./Error.css.json');
function ErrorIndicator(props) {
    return (react_1.default.createElement("div", { className: styles.container },
        react_1.default.createElement("i", { className: [styles.icon, 'fas fa-exclamation-triangle'].join(' ') })));
}
exports.ErrorIndicator = ErrorIndicator;
exports.default = ErrorIndicator;

},{"./Error.css.json":3,"react":23}],5:[function(require,module,exports){
"use strict";
var __importDefault = (this && this.__importDefault) || function (mod) {
    return (mod && mod.__esModule) ? mod : { "default": mod };
};
...
function LoadingIndicator(props) {
    return (react_1.default.createElement("i", { className: "fas fa-spinner fa-pulse" }));
}
exports.LoadingIndicator = LoadingIndicator;
exports.default = LoadingIndicator;

},{"react":23}],6:[function(require,module,exports){
module.exports={"container":"_container_chlhz_1","temperature":"_temperature_chlhz_6","weather":"_weather_chlhz_8","icon":"_icon_chlhz_10","large":"_large_chlhz_13"}
...
var hooks_1 = require("../../hooks");
var LoadingIndicator_1 = __importDefault(require("../LoadingIndicator/LoadingIndicator"));
var styles = require('./WeatherIndicator.css.json');
function WeatherIndicator(props) {
    var weather = props.weather;
    var info = hooks_1.useDarkSkyIcon(weather.icon).info;
    if (!props.weather) {
        return (react_1.default.createElement(LoadingIndicator_1.default, null));
    }
    function renderTemperature() {
        var render = [];
        render.push(react_1.default.createElement("span", { key: 'high' },
            weather.temperatureHigh ? Math.round(weather.temperatureHigh) : Math.round(weather.temperature),
            "\u00B0"));
        if (weather.temperatureLow) {
            render.push(react_1.default.createElement("span", { key: 'low', className: styles.low },
    ...
    return (react_1.default.createElement("div", { className: [styles.container, props.size ? styles[props.size] : ''].join(' ') },
        info ? react_1.default.createElement("i", { className: ['fas', info.icon, styles.icon].join(' ') }) : react_1.default.createElement(LoadingIndicator_1.default, null),
        react_1.default.createElement("div", { className: styles.weather }, weather.summary),
        react_1.default.createElement("div", { className: styles.temperature }, renderTemperature())));
}
exports.WeatherIndicator = WeatherIndicator;
exports.default = WeatherIndicator;

},{"../../hooks":10,"../LoadingIndicator/LoadingIndicator":5,"./WeatherIndicator.css.json":6,"react":23}],8:[function(require,module,exports){
module.exports={"container":"_container_unlk2_1","content":"_content_unlk2_1","title":"_title_unlk2_10"}
...
Object.defineProperty(exports, "__esModule", { value: true });
var react_1 = __importDefault(require("react"));
var CurrentCard_1 = __importDefault(require("../CurrentCard/CurrentCard"));
var styles = require('./WorldWeather.css.json');
var shortcuts = {
...
function WorldWeather(props) {
    var render = [];
    for (var _i = 0, _a = Object.entries(shortcuts); _i < _a.length; _i++) {
        var _b = _a[_i], key = _b[0], val = _b[1];
        render.push(react_1.default.createElement(CurrentCard_1.default, { key: key, city: key, latitude: val[0], longitude: val[1] }));
    }
    return (react_1.default.createElement("div", { className: styles.container },
        react_1.default.createElement("p", { className: styles.title }, "Weather Around the World"),
        react_1.default.createElement("div", { className: styles.content }, render)));
}
exports.WorldWeather = WorldWeather;
exports.default = WorldWeather;

},{"../CurrentCard/CurrentCard":2,"./WorldWeather.css.json":8,"react":23}],10:[function(require,module,exports){
"use strict";
function __export(m) {
    for (var p in m) if (!exports.hasOwnProperty(p)) exports[p] = m[p];
}
Object.defineProperty(exports, "__esModule", { value: true });
__export(require("./useActiveTheme"));
__export(require("./useDarkSkyIcon"));
__export(require("./useLocalStorage"));
__export(require("./useLocationName"));
__export(require("./useLocationWeather"));
__export(require("./usePrevious"));

},{"./useActiveTheme":11,"./useDarkSkyIcon":12,"./useLocalStorage":13,"./useLocationName":14,"./useLocationWeather":15,"./usePrevious":16}],11:[function(require,module,exports){
"use strict";
var __importDefault = (this && this.__importDefault) || function (mod) {
    return (mod && mod.__esModule) ? mod : { "default": mod };
};
...
function useActiveTheme() {
    var localStorage = useLocalStorage_1.default();
    var storedTheme = localStorage.get('theme');
    var _a = react_1.useState(localStorage.get('theme') || 'light'), activeTheme = _a[0], setActiveTheme = _a[1];
...
exports.useActiveTheme = useActiveTheme;
exports.default = useActiveTheme;

},{"./useLocalStorage":13,"react":23}],12:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var react_1 = require("react");
;
...
function useDarkSkyIcon(icon) {
    var _a = react_1.useState(null), info = _a[0], setInfo = _a[1];
    react_1.useEffect(function () {
        if (!infoMap[icon]) {
            setInfo(null);
        }
...
exports.useDarkSkyIcon = useDarkSkyIcon;
exports.default = useDarkSkyIcon;

},{"react":23}],13:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
function useLocationName(location) {
    ...
    react_1.useEffect(function () {
        ...
        var city = addressComponents.find(function (component) { return component.types.includes('locality'); });
        var state = addressComponents.find(function (component) { return component.types.includes('administrative_area_level_1'); });
        var country = addressComponents.find(function (component) { return component.types.includes('country'); });
        function appendToLabel(original, toAppend) {
...
exports.default = useLocationName;

},{"react":23}],15:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var react_1 = require("react");
function useLocationWeather(latitude, longitude, currentOnly) {
    var _a = react_1.useState(null), weather = _a[0], setWeather = _a[1];
    var _b = react_1.useState(false), loading = _b[0], setLoading = _b[1];
    var _c = react_1.useState(null), error = _c[0], setError = _c[1];
    react_1.useEffect(function () {
        setLoading(true);
        var reqUrl = "/weather/" + latitude + "/" + longitude;
        if (currentOnly) {
    ...
    return { weather: weather, loading: loading, error: error };
}
exports.useLocationWeather = useLocationWeather;
exports.default = useLocationWeather;
...
},{"react":23}],17:[function(require,module,exports){
/*
object-assign
(c) Sindre Sorhus
@license MIT
...
},{"_process":18,"object-assign":17,"prop-types/checkPropTypes":19}],22:[function(require,module,exports){
/** @license React v16.10.2
...
},{"object-assign":17}],23:[function(require,module,exports){
(function (process){
'use strict';
